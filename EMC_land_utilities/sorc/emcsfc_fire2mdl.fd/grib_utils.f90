...
!
! remarks: replacement for ncep g2 library routine gf_free, which is
!   buggy and can cause memory leaks.
!
!$$$
!
 use grib_mod 
...
! files: 
!   input:
!     - the file to be checked, fort.11
!
!   output: none
!
! condition codes:
...
!
! condition codes:
!   50 - unrecognized grid type; fatal
!
! remarks: none.
!
!$$$
!
 ...
 elseif (igdtnum.eq.1) then    ! Rotated Lat/Lon grid
   ...
   print*,'- ** FATAL ERROR CONVERTING GRIB2 GDT'
