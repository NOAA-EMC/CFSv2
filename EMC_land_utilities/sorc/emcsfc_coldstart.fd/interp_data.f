...
! $Revision$
!
! abstract: contains driver routines used to interpolate
! surface fields from one grid to another.
!
!  subroutine interp - driver routine to do interpolation
!  subroutine get_fg - read nemsio file with interpolated gfs
!       land states.
!
! program history log:
! 2005-08-03  gayno     - initial version
!
! usage: use interp_data
!
! module variable definitions:
!
!   data_output - data structure that holds the surface data
!                 interpolated to the output grid
!   nsoil_output- # of soil layers on output grid
!
! remarks: none
!
!$$$
...
!   prgmmr: gayno          org: w/np2           date: 2005-08-03
!
! abstract: driver routine to interpolate data from input to output grids
!
! program history log:
! 2005-08-03  gayno     - initial version
!
! usage:  include this module, then 'call interp' with no arguments.
!
! files: none
!
...
!   prgmmr: gayno          org: w/np2           date: 2005-08-03
!
! abstract: read nemsio file with interpolated gfs land states
! and place each record in the proper data_output array.
!
! program history log:
! 2005-08-03  gayno     - initial version
!
! usage:  call get_fg with no arguments.
!
! files:
!   input:
...
!
! condition codes: all fatal
!   35 - error reading model restart file
!
! remarks: 
!
! this routine only reads 'state' fields.  climo fields
