...
! $Revision$
!
! abstract: contains routines to write the interpolated surface 
!   fields to the output grid's restart file.
!
! program history log:
! 2005-08-03  gayno     - initial version
!
! usage: use write_data
!
! remarks: none
!
!$$$
...
!
! subprogram:  write_output_data_driver
!   prgmmr: gayno          org: w/np2           date: 2005-08-03
!
! abstract: driver routine to write the surface fields to
!   the output grid restart file.
!
! program history log:
! 2005-08-03  gayno     - initial version
!
! usage:  call write_output_data_driver with no arguments
!
! files: none
!
! condition codes:
...
!$$$ subroutine documentation block
!
! subprogram:  write_output_data_arwnetcdf
!   prgmmr: gayno          org: w/np2           date: ????
!
! abstract: update surface records for an arw netcdf file
!
! program history log:
! ????        gayno     - initial version
!
! usage:  call write_output_data_arwnetcdf with no arguments
!
! files: 
!    input: none
!
...
!
! condition codes:
!   36 - bad write to arw restart file
!
! remarks: none
!
!$$$
...
!$$$ subroutine documentation block
!
! subprogram:  write_output_data_nmmnetcdf
!   prgmmr: gayno          org: w/np2           date: ????
!
! abstract: update surface records for a nmm netcdf file
!
! program history log:
! ????        gayno     - initial version
!
! usage:  call write_output_data_nmmnetcdf with no arguments
!
! files: 
!    input: none
!
...
!
! condition codes:
!   37 - bad write to nmm restart file
!
! remarks: none
!
!$$$
...
!$$$ subroutine documentation block
!
! subprogram:  write_output_data_nems
!   prgmmr: gayno          org: w/np2           date: ????
!
! abstract: update surface records for an nmm nemsio file.
!
! program history log:
! ????        gayno     - initial version
!
! usage:  call write_output_data_nems with no arguments
!
! files: 
!    input: none
!
!    output: 
!      - nmm restart file in nemsio format
!
! condition codes:  all fatal
!   34 - error writing nemsio restart file
!   94 - error initializing nemsio module
!   95 - error opening nemsio restart file
!
! remarks: none
!
!$$$
