...
#---------------------------------------------------------------------------------
#  The driver script for compiling the emcsfc_sst2mdl program.  Loads
...
v????.ncep.noaa.gov | m????.ncep.noaa.gov)
  ...
  echo
  echo "BUILD EMCSFC_SST2MDL PROGRAM ON WCOSS DELL."
  echo

  module purge
  module load EnvVars/1.0.2
  module use ../../modulefiles
  module load module.sst2mdl.wcoss.dell
...
g????.ncep.noaa.gov | t????.ncep.noaa.gov)
  ...
  echo
  echo "BUILD EMCSFC_SST2MDL PROGRAM ON WCOSS PHASE 1 AND PHASE 2."
  echo
...
llogin? | slogin?)
  ...
  echo
  echo "BUILD EMCSFC_SST2MDL PROGRAM ON WCOSS-CRAY."
  echo

  module purge
  module load modules/3.2.6.7
  module load ../../modulefiles/module.sst2mdl.wcoss.cray
...
tfe??) 
  ...
  echo
  echo "BUILD EMCSFC_SST2MDL PROGRAM ON THEIA" 
  echo
