...
v????.ncep.noaa.gov | m????.ncep.noaa.gov)
  ...
  echo
  echo "BUILD EMCSFC_ICE_BLEND PROGRAM ON WCOSS DELL."
  echo

  module purge
  module load EnvVars/1.0.2
  module use ../../modulefiles
  module load module.ice_blend.wcoss.dell
...
g????.ncep.noaa.gov | t????.ncep.noaa.gov) 
  ...
  module purge
  module load ../../modulefiles/module.ice_blend.wcoss
...
llogin? | slogin?)
  ...
  module load ../../modulefiles/module.ice_blend.wcoss.cray
