...
!
! condition codes:
!    40 - unrecognized grid type; fatal
!
! remarks: none.
!
!$$$
...
!      kgds                         - grib1 grid desc sect information
!      idrstmplen                   - length of grib2 data representation 
!                                     template.
!      igdstmplen                   - length of grib2 grid defintion
!                                     template.
...
!      idrsnum                      - grib2 data repres sect template number
!      ipdsnum                      - grib2 product def sect template number
!      idrstmpl                     - grib2 data repres sect template array
!      ipdstmpl                     - grib2 product def sect template array
!      igdstmpl                     - grib2 grid defintion template array
...
!          the gds template length.  this is a function of
!          map projection.
!          
!$$$
 ...
 integer, intent(in   )        :: kgds(200), igdstmplen, idrstmplen
 integer, intent(  out)        :: igds(5)
 integer, intent(  out)        :: listsec0(2)
 integer, intent(  out)        :: listsec1(13)
 integer, intent(  out)        :: ipdstmpl(15), ipdsnum, idrsnum
 integer, intent(  out)        :: igdstmpl(igdstmplen), idrstmpl(idrstmplen)
...
! Section 0
 ...
 listsec0(1)=10 ! discipline, oceanographic fields
...
! Section 4 - product definition section
 ...
 ipdsnum = 0            ! octs 8-9; pds template number - table 4.0 - 
                        ! analysis at one level
 ipdstmpl(1)= 2         ! oct 10; parameter category, ice
! note!! to use a parmeter number >= 192 you must set the local table to '1'
 ipdstmpl(2)= 0         ! oct 11; parameter, ice cover, proportion
...
! Section 5 - data representation section.
 ...
 idrsnum     = 0   ! section 5 template number, use simple packing
 idrstmpl    = 0
 idrstmpl(3) = 2   ! decimal scaling factor
