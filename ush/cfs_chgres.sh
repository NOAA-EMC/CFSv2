...
#                          GFSOUT OUTTYP IDRT NSTINP NSTOUT
#
...
#                   defaults to input sigma file value
#     NWPROD        A string that defaults to $NWROOT
...
#                   defaults to ${FIXGLOBAL}/global_orography_uf.t${JCAP}.$LONB.$LATB.grb
