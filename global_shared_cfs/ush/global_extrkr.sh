...
synvitdir=${synvitdir:-${COMDIR}${COMROOT}/gfs/prod/gfs.${PDY}}
synvitfile=${synvitfile:-gfs.t${CYL}z.syndata.tcvitals.tm00}
synvitold_dir=${synvitold_dir:-${COMDIR}${COMROOT}/gfs/prod/gfs.${old_4ymd}}
synvitold_file=${synvitold_file:-gfs.t${old_hh}z.syndata.tcvitals.tm00}
synvitfuture_dir=${synvitfuture_dir:-${COMDIR}${COMROOT}/gfs/prod/gfs.${future_4ymd}}
