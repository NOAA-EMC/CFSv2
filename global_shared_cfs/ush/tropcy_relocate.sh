...
#  -----------------------------------------------------------
   ...
   ln -sf $DATA/rel_inform1        fort.52
   ln -sf $DATA/tcvitals.relocate0 fort.55

   ln -sf $DATA/sgm3prep    fort.20
   ln -sf $DATA/sgesprep    fort.21
   ln -sf $DATA/sgp3prep    fort.22

   ln -sf $DATA/sgm3prep.relocate fort.53
   ln -sf $DATA/sgesprep.relocate fort.56
   ln -sf $DATA/sgp3prep.relocate fort.59
...
#  ------------------------------------------------------------------
   ...
   gesfhr=3; echo $gesfhr $LONB $LATB >parm.0
   gesfhr=6; echo $gesfhr $LONB $LATB >parm.1
   gesfhr=9; echo $gesfhr $LONB $LATB >parm.2
...
#  -------------------------------------
   ...
   export RELOX_threads=${RELOX_threads:-5}
