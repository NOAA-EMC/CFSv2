...
C PROGRAM HISTORY LOG:
C 1990-11-06  J. WOOLLEN - ORIGINAL AUTHOR
C 2013-03-26  J. WOOLLEN  INITIAL PORT TO WCOSS: FIX ADDRESSING
C         ALIGNMENT PROBLEM WHEN THE LAST BUFR MESSAGE CONTAINS NO DATA
C         WHICH IS OIQC PROCESSED
C
...
C  -----------------------------------------------------------
      ...
      IF(IREC.LT.JREC.OR.ILEV.EQ.NLEV) THEN
         ...
         DO WHILE(IREC.LT.JREC.OR.ILEV.EQ.NLEV)
            CALL CLOSMG(LUBOT)
