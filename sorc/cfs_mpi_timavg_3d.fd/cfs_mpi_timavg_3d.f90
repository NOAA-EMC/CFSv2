...
!
      ...
      open(5,file="input1",status="old",form="formatted",access="sequential")!
...
!         if (nrank == dbgme) print*,'ijdim = ',ijdim
          ...
          if (iret.ne.0) call mpi_abort(MPI_COMM_WORLD,222,ierr)
