...
!
! MAIN PROGRAM:  GODAS_MKDLYASMPRF
...
!              real_indx = float(n-1) + ...
! 2008-07-11  David W. Behringer - Copied from mkAsmPrf.f
...
!
!   OUTPUT FILES:
!     UNIT 51  - ASSIGNED TO A SUCCESSION OF TEMPERATURE PROFILE FILES
...
!
      program mkDlyAsmPrf
!
!  mkDlyAsmPrf prepares profiles for use in assimilation
!
      use tmutil_mod
!
      include 'netcdf.inc'
...
!
      call w3tagb('GODAS_MKDLYASMPRF',2003,0164,0164,'NP23')
!
