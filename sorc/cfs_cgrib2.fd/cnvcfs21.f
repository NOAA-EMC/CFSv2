      subroutine cnvcfs21(ifl1,ifl2)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    cnvcfs21 
...
C 2010-11-17  Vuong    - Modified to work with CFS
C
C USAGE:    CALL cnvcfs21(ifl1,ifl2)
...
!      
     ...
     &                kgds,igrid,iret)
         ...
         !   Construct PDS
         !
         call makepdscfs(gfld%discipline,gfld%idsect,gfld%ipdtnum,
