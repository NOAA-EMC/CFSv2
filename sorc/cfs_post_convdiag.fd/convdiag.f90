...
! dwork_ges
   ...
   program convdiag
   parameter(maxn=2000000,mxtb=2000000,maxsub=49)
...
!  read in the prepbufr station ids
   ...
   if(nprp>=mxtb) call bort('cnvdiag ufbtam mxtb overflow')
...
!  read the prepbufr file in order of station id              
    ...
    pilot=ntyp.eq.221.or.ntyp.eq.223.or.ntyp.eq.224.or.ntyp.eq.229
