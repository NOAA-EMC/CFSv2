...
C-----------------------------------------------------------------------
      ...
      if(allocated(iarps)) return
      allocate (iarps(imax,jmax,nbak))
      allocate (iarzs(imax,jmax,nbak))
      allocate (iarqq(imax,jmax,kmax,nbak))
      allocate (iartt(imax,jmax,kmax,nbak))
      allocate (iaruu(imax,jmax,kmax,nbak))
      allocate (iarvv(imax,jmax,kmax,nbak))
      allocate (iarpl(imax,jmax,kmax,nbak))
      allocate (iarzl(imax,jmax,kmax,nbak))
