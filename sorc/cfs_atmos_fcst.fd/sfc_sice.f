...
!  ---  inputs:
     ...
     &       cm, ch, rcl, prsl1, prslki, slimsk, ddvel,                 &
     &       flag_iter, mom4ice, lsm,                                   &
!  ---  input/outputs:
     &       hice, fice, tice, sheleg, tskin, tprcp, stc, ep,           &
!  ---  outputs:
...
!                     the code and added program documentation block.   !
!                                                                       !
!                                                                       !
...
!  ---  input/outputs:
     ...
     &       fice, tice, sheleg, tskin, tprcp, ep
...
!  ---  locals:
     ...
     &       snowd, theta1, tv1, xrcl, ps1, wind
