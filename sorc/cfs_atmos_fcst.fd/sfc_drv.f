...
!            rcl, prsl1, prslki, slimsk, ddvel, slopetyp,               !
!            shdmin, shdmax, snoalb, sfalb, flag_iter, flag_guess,      !
!  ---  in/outs:                                                        !
!            sheleg, snwdph, tskin, tprcp, srflag, smc, stc, slc,       !
!            canopy, trans, tsurf,                                      !
!  ---  outputs:                                                        !
...
!  ---  input:
     ...
     &       ch, rcl, prsl1, prslki, slimsk, ddvel, shdmin, shdmax,     &
     &       snoalb, sfalb
...
!  ---  locals:
     ...
     &       q0, qs1, theta1, tv1, xrcl, wind, sheleg_old, snwdph_old,  &
