cfpp$ noconcur r
     ...
     &     uo,vo,t1,q1,swh,hlw,xmu,slimsk,
...
c
      ...
      enddo
c
c  diffusivity in the inversion layer over sea is set to be 0.3 m^2/s
c
      do k = 2,kmpbl
        do i=1,im
          if(slimsk(i).eq.0 .and.
     &      (zi(i,k+1).gt.300..and.zi(i,k+1).lt.zstblmax)) then
