...
!                                                                       !
!  program history log:                                                 !
!    jun  2003  -- k. mitchell et al. land group created version 2.7    !
!    feb  2004  -- m. ek       noah v2.7.1                              !
...
!                       streamlined and reformatted code, consolidated  !
!                       constents/parameters by using module physcons,  !
!                       and added program documentations.               !
!    sep 2009   -- y. xia & h. wei modified subroutine redprm, changed  !
!                       dksat and kdt according to mopex calibration    !
!                       and set slope to 1 as in wrf.                   !
!                                                                       !
...
!  --- ...  set-up soil parameters
      ...
      bexp  = bb   (soiltyp)
!     dksat = satdk(soiltyp)
      dksat = 5.5 * satdk(soiltyp)       ! multiply by 5.5 based on mopex calib.
      dwsat = satdw(soiltyp)
      f1    = f11  (soiltyp)
!     kdt   = refkdt * dksat / refdk
      kdt   = 2.59 - 0.044*dksat         ! from mopex calibration
...
!           use uniform (=1) slope as wrf and the current ops cfs (osu lsm)
