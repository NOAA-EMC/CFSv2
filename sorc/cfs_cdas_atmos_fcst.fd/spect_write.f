...
c$$$      common /z00_com/z
!!
!     write(0,*)' enter spect_write_fd ' 		! hmhj
...
!     write(0,*)' thermodyn_id=',thermodyn_id,' cpi=',
!    &head%cpi(0:ntrac+1),' ri=',head%ri(1:ntrac+1)
        else if (hybrid) then					! hmhj
...
!!
!!
!     write(0,*)' leave spect_write_fd for fhour=',fhour
