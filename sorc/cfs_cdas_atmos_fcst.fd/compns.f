...
!     ialb    = 0         ! use climatology alb, based on sfc type
      ...
      ictm    = 0         ! use current fcst time/date for external data
                          ! ictm=1 will use external data at initial time
                          ! ictm=2 will use latest external data at or before
                          ! initial time, but no extrapolation
!
