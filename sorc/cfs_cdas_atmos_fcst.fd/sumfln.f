...
cc
     ...
     x                  lons_lat,londi,latl)
      ...
      integer              ls_node(ls_dim,3)
      integer              j, k, l, lat, lat1, n
      real(kind=kind_evod) apev((5*levs+1*levh+3)*2,latl2)! real(kind=ki
      real(kind=kind_evod) apod((5*levs+1*levh+3)*2,latl2)! real(kind=ki
      integer              num_threads
      integer              num_parthds
      integer              nvar_thread_max
      integer              nvar_1,nvar_2
...
c
      subroutine sumfln_r(flnev,flnod,lat1s,plnev,plnod,
     x                  nvars,ls_node,latl2,
     x                  lslag,workdim,nvarsdim,four_gr,
     x                  ls_nodes,max_ls_nodes,
     x                  lats_nodes,global_lats,
...
c
      subroutine sumflna_r(flnev,flnod,lat1s,plnev,plnod,
     x                  nvars,ls_node,latl2,
     x                  lslag,workdim,nvarsdim,four_gr,
     x                  ls_nodes,max_ls_nodes,
     x                  lats_nodes,global_lats,
