...
!
  ...
  integer, parameter :: nfix = 18
  character(len=20), dimension(18) :: fxFld
  data fxFld /'xt_ocean','yt_ocean','time', &
   'nv','xu_ocean','yu_ocean','zt_ocean','zt_edges_ocean','zw_ocean', &
   'zw_edges_ocean', 'geolon_t', 'geolat_t', 'geolon_c', 'geolat_c', &
