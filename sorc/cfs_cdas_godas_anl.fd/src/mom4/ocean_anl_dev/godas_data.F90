...
!   tuningF          = a handy tuning parameter
...
real    :: acoef, hrscl, vcvn, vsclf, no_lat_mx, tuningF
...
!   id_dg_cor  = id's for managing diagnostics
!   id_dg_rstr = id's for managing diagnostics

integer           :: kass2, kass3, kass4, asm_cnt
type(time_type)   :: gds_freq, alrm_dur
logical           :: ovr_alrm
integer, allocatable, dimension(:) :: id_dg_cor
integer, allocatable, dimension(:) :: id_dg_rstr
...
!    and Rosati (1989) and will be dimensioned (isd:ied,jsd:jed,kass2)
...
!
!    The gmask has dimensions of (isd:ied,jsd:jed,kass2)
!
real, save, dimension(:,:,:), allocatable :: gmask
!
