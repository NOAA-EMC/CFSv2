...
!This is the version for the transpose method
  ...
  character(len=128), private :: version = '$Id: spec_mpp.f90,v 1.4 2004/12/10 19:35:16 gtn Exp $'
  character(len=128), private :: tagname = '$Name: mom4p0d $'
