...
!-----------------------------------------------------------------------
  character(len=128) :: version = '$Id: flux_exchange.f90,v 1.5 2005/05/12 21:41:04 gtn Exp $'
...
! real, dimension(:,:),   intent(out) :: dt_t_atm, dt_q_atm
  ...
  real, dimension(n_xgrid_sfc) :: ex_t_surf_new, ex_dt_t_surf,  &
       ex_dt_t, ex_dt_q, ex_delta_t_n,  ex_delta_q_n, &
       ex_t_ca_new,   ex_dt_t_ca, ex_q_surf_new, ex_dt_q_surf
       ! + slm, Mar 20 2002
       ! - slm, Mar 20 2002
