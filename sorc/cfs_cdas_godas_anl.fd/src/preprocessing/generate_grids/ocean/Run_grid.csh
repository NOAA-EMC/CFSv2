...
# --- set up namelist
    ...
    cat >input.nml <<!
     &ocean_grid_generator_nml
       ...
       output_file = '$name.nc'  /    
    &hgrid_nml
       nxlons=2,x_lon=0.,360.,dx_lon=0.5,0.5,
       nylats=6,y_lat=-75.,-31.,-10.,10.,31.,65.,dy_lat=0.5,0.5,0.25,0.25,0.5,0.5
       tripolar_grid=.false.,lat_join=65, 
       debug = .true. /
    &vgrid_nml
       nzdepths=3,z_depth=0.0,220.0,5200.0,dz_depth=10.0,10.0,488.0
       debug = .true. 
       stretch_z = 1.04/
    &topog_nml
       deepen_shallow=.true.
       ...
       topog_file='$root/data/topog/OCCAM_p2degree.nc',
       topog_field='topo',
       fill_first_row = .true.
       kmt_min=5,
       filter_topog=.false.,
