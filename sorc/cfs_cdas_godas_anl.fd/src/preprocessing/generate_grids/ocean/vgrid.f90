module vgrid_mod
  ...
  !</DATA>
  !</NAMELIST>
  namelist /vgrid_nml/ nzdepths, z_depth, dz_depth, stretch_z, read_my_grid, my_grid_file, debug
  ...
  !---------version information-------------------------------------------
  character(len=128) :: version = '$Id: vgrid.f90,v 1.3 2005/05/12 21:41:05 gtn Exp $'
...
10  call close_file (unit)
    ...
    if (read_my_grid) then
       ...
       call make_axis('Z',maxlen, nzdepths,z_depth,dz_depth,zb0,zt0,nk, .false., .false.,.false., .false.)
