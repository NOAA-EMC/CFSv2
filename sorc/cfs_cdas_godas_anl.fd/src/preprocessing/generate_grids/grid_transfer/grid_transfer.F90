...
#include <netcdf.inc>
  ...
  !---------version information-------------------------------------------
  character(len=128) :: version = '$Id: grid_transfer.F90,v 1.3 2005/05/12 21:41:05 gtn Exp $'
...
contains
  ...
  subroutine write_new_grid
    ...
    integer :: ncid, rcode, dims(10), start(4), nwrite(4)
    ...
    integer :: id_ds_02_22_c, id_ds_20_22_c, id_area_t
